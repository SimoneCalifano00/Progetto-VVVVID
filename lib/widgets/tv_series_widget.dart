...
class TvSeriesContainer extends StatefulWidget {
  const TvSeriesContainer(this.currUser);
  final User currUser;

  @override
  State<TvSeriesContainer> createState() => _TvSeriesContainerState();
}

class _TvSeriesContainerState extends State<TvSeriesContainer> {
  @override
    ...
    void _dropdownCallback(String? selectedValue) {
      if (selectedValue is String) {
        ...
        pushNewScreen(context,
            screen:
                GeneriScreen(selectedValue, widget.currUser, Sezione.SerieTV));
      }
    }
